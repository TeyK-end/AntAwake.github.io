...
const contentMap = {
  "Địa Điểm": {
    mainContent: {
      ...
      description:
        "Các địa danh nổi tiếng và phong cảnh tuyệt đẹp đang chờ bạn khám phá.",
    },
    imgtilte2_1: {
      imageSrc: "image/chùa.png",
      title: "Chùa Ông Bổn",
      description:
        "Chùa Ông Bổn tại quận 5, TP.HCM, là ngôi chùa lâu đời của người Hoa.",
    },
    imgtilte2_2: {
...
function updateHighlight(item) {
    if (item && highlight && item.parentElement) {
...
function initializeContent() {
    ...
    // Đợi animation hoàn tất rồi cập nhật highlight
    setTimeout(() => {
        updateHighlight(defaultItem);
    }, 600); // Delay 600ms để đảm bảo animation faded hoàn tất
